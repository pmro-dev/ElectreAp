...
namespace ElectreAp
{
    interface IElectreIII : IAlgorithm
    {
        ...
        void ExchangingListOfRanksToTable(List<List<Int32>> listOfRanks);
        ...
        void ShowOptionRankingOfDistillation(String[][] rankingOfOptionsAfterDistillation);
